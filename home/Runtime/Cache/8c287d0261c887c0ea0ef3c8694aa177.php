...
-->
	...
	<div id="container">
		...
		<center><b>最新活动</b></center>

		<?php if(!empty($my_content)): if(is_array($my_content)): $i = 0; $__LIST__ = $my_content;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!-- <hr class="hr1"> -->
