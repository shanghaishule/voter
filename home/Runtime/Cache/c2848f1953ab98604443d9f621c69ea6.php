...
-->
	...
	<div id="container">
		<?php if($type == '1'): ?><center><b>创卫活动</b></label></center>
			<title>创卫活动</title>
		<?php elseif($type == '2'): ?>
			<center><b>活动简讯</b></label></center>
			<title>活动简讯</title>
<!-- 		<?php elseif($type == '3'): ?>
			<center><b>项目简介</b></label></center>
			<title>项目简介</title> --><?php endif; ?>
			
		<?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><hr class="hr1">
			<a href="__APP__/Contents/article_detail?c_id=<?php echo ($vo['c_id']); ?>">
