...
<!-- 		<div class="auth">
			<center>作者：<?php echo ($res['v_id']); ?></center>
		</div> -->
		<div class="contents"><?php echo ($res['contents']); ?></div>
<!-- 		<?php if($res['pic'] != ''): ?><div class="pic"><img src="__PUBLIC__/Uploads/<?php echo ($res['pic']); ?>"></div><?php endif; ?> -->
	</div>
