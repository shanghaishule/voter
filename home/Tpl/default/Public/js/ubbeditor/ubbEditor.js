function ubbEditor(_id)
{
  ...
  this.tToolbarSets['default'] = ['Bold','Italic','Underline','separator','Image','Smiley','separator','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','separator','OrderedList','UnorderedList','TextColor','BGColor'];
